...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-600 body-font bg-[#F8FFE5]">
        <motion.div
          ...
          className="container px-5 py-16 mx-auto text-xl"
        >
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-[#06D6A0] tracking-widest text-2xl mb-3">
                Info
              </h2>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                ...
                <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-[#06D6A0] border-0 py-2 px-6 focus:outline-none hover:bg-green-700 rounded">
                  SUBSCRIBE
                </button>
              </div>
            </div>
