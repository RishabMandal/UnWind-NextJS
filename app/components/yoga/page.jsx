...
const Yoga = () => {
  ...
  return (
    <div className="bg-[#F8FFE5]">
      <div className={`font-semibold text-6xl text-center pt-10 mb-1 ${silkscreen.className}`}>
        <a className="text-[#06D6A0] font-bold text-8xl">YOGA</a> IS A
        LIFESTYLE
      </div>
      <div className="p-5 md:p-16 flex flex-wrap justify-between">
        {name.map((n, i) => {
          return (
            <div className="my-4">
